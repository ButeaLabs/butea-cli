...
const PACKAGE_MAP = {
  'darwin-arm64':  { pkg: '@butea/cli-darwin-arm64',  bin: 'butea' },
  'darwin-x64':    { pkg: '@butea/cli-darwin-x64',    bin: 'butea' },
  'linux-arm64':   { pkg: '@butea/cli-linux-arm64',   bin: 'butea' },
  'linux-x64':     { pkg: '@butea/cli-linux-x64',     bin: 'butea' },
  'win32-arm64':   { pkg: '@butea/cli-windows-arm64', bin: 'butea.exe' },
  'win32-x64':     { pkg: '@butea/cli-windows-x64',   bin: 'butea.exe' },
};
